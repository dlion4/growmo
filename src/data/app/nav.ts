...
export const APP_NAV: AppNavGroup[] = [
  {
    ...
    items: [
      ...
      { to: "/app/dashboard", label: "Dashboard", desc: "Command center", icon: LayoutDashboard, ready: false, page: 2 },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/map", label: "Farm Map", desc: "Plots & GPS", icon: Map, ready: false, page: 19 },
